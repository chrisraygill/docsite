...
description: Start from a TanStack Start app and expose the same recipe flow from the main quickstart using API routes and the Genkit fetch handler.
supportedLanguages:
  - js
---
...
Use this guide when you're starting from a TanStack Start app and want to add Genkit flows as API endpoints alongside your TanStack Router pages.
