...
Use this guide to learn how to add agentic AI features to a FastAPI app. You will build **Bargain Chef**: a FastAPI service that streams a recipe field-by-field as the model generates it, calling a tool to look up today's grocery sale prices and grounding the ingredients in the deals.
